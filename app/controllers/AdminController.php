...
class AdminController
{
    ...
    public function saveLandingSetting(): void
    {
        ...
        $allowed = [
            ...
            'poster_section_heading', 'poster_section_subtitle',
            // Poster slots with title and subtitle
            ...
            'landing_about_text',
            // Stats section
            'stats_number_1', 'stats_label_1',
            'stats_number_2', 'stats_label_2',
            'stats_number_3', 'stats_label_3',
            ...
            'writer_step1_title', 'writer_step1_text',
            'writer_step2_title', 'writer_step2_text',
            'writer_step3_title', 'writer_step3_text',
            'writer_form_heading', 'writer_form_description',
            'writer_terms_text',
            'writer_field_name_label', 'writer_field_name_placeholder',
            'writer_field_email_label', 'writer_field_email_placeholder',
            'writer_field_phone_label', 'writer_field_phone_placeholder',
            'writer_field_video_label', 'writer_field_video_hint',
            'director_hero_label', 'director_hero_heading', 'director_hero_description',
            'director_step1_title', 'director_step1_text',
            'director_step2_title', 'director_step2_text',
            'director_step3_title', 'director_step3_text',
            'director_form_heading', 'director_form_description',
            'director_terms_text',
            'director_field_name_label', 'director_field_name_placeholder',
            'director_field_email_label', 'director_field_email_placeholder',
            'director_field_phone_label', 'director_field_phone_placeholder',
            'director_field_video_label', 'director_field_video_hint',
            'actor_hero_label', 'actor_hero_heading', 'actor_hero_description',
            'actor_step1_title', 'actor_step1_text',
            'actor_step2_title', 'actor_step2_text',
            'actor_step3_title', 'actor_step3_text',
    ...
    public function saveLandingSettingsBatch(): void
    {
        ...
        $allowed = [
            'site_logo_url', 'site_logo_height',
            'landing_headline', 'landing_hero_pre_video_text', 'landing_hero_top_text', 'landing_hero_subheading', 'landing_hero_tagline', 'site_tagline',
            'landing_header_content', 'landing_footer_content',
            'landing_roles_heading', 'landing_roles_subheading',
            // Poster section headings
            'poster_section_heading', 'poster_section_subtitle',
