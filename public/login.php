...
$title = 'Login — Faceless Pictures 3';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="min-h-screen flex" x-data="loginForm()">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 pattern-bg">
            <div class="w-full max-w-[420px]">
                ...
                <a href="/api/auth/google" class="w-full bg-white border-2 border-dark/10 rounded-xl py-4 flex items-center justify-center gap-3 text-[14px] font-medium text-dark hover:border-dark/20 transition">
