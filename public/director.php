...
?>
  ...
  <div class="brief-card">
    <!-- Card heading from Scripts backend (same as Actor page) -->
    <div class="card-sec" style="background:#f3f4f6;border-bottom:1px solid #e5e7eb;padding:1.25rem 1.25rem 1rem;text-align:center">
      <p style="font-family:'Bebas Neue',sans-serif;font-size:2rem;letter-spacing:.08em;color:#111;line-height:1;margin-bottom:0"><?= strtoupper($cardTitle) ?></p>
    </div>
  ...
  <div class="submit-card" style="margin:0" x-data="directorSubmit()">
    ...
    <div style="margin:-2.25rem -2rem 1.5rem;padding:1.5rem;background:#fafafa;border-bottom:1px solid #e5e7eb">
