  ...
  <div class="submit-card" style="margin:0" x-data="directorSubmit()">
    ...
    <div style="margin-top:1.25rem">
      <label style="display:flex;align-items:start;gap:.75rem;cursor:pointer;user-select:none">
        ...
        <span style="color:#374151;font-size:.85rem;line-height:1.5"><?= htmlspecialchars($settingsModel->get('director_terms_text', 'I agree to the terms and conditions and confirm all information provided is accurate')) ?></span>
      </label>
    </div>
