                                    ...
                                    <div class="bg-dark/[.025] rounded-xl p-4 space-y-3" x-data="imageUploader('<?= $p[1] ?>', '<?= addslashes(htmlspecialchars($currentUrl)) ?>')">
                                        ...
                                        <div x-data="videoUploader('<?= $p[3] ?>', '<?= addslashes(htmlspecialchars($settingsModel->get($p[3], ''))) ?>')">
                                            ...
                                            <div x-show="trailerTab==='yt'">
                                                ...
                                                <p class="text-[10px] text-dark/25 mt-1">YouTube URL takes priority over uploaded file when both are set</p>
                                            </div>
    ...
    function videoUploader(fieldKey, initialUrl) {
        ...
        return {
            ...
            setYtUrl(val) {
                ...
                fd.append('value', val);
                fetch('/api/admin/settings/landing', { method: 'POST', body: fd, credentials: 'same-origin' });
            },
