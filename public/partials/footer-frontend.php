    ...
    <div class="footer-top">
      ...
      <nav class="footer-nav">
        <div class="footer-nav-column">
          <h4 class="footer-nav-heading">Roles</h4>
          <a href="/actor" class="footer-link">Actor Auditions</a>
          <a href="/director" class="footer-link">Director Auditions</a>
          <a href="/writer" class="footer-link">Writer Submissions</a>
        </div>
