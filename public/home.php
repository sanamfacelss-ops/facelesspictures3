...
.fp-nav-container{max-width:1280px;margin:0 auto;padding:0 1rem;height:100%;display:flex;align-items:center;justify-content:center;gap:2rem;position:relative}
.nav-logo{font-family:'Bebas Neue',sans-serif;font-size:19px;letter-spacing:.06em;color:#111;text-decoration:none;display:flex;align-items:center;gap:6px;flex-shrink:0}
.logo-text{font-family:'Bebas Neue',sans-serif;font-size:20px;letter-spacing:.06em;color:#111}
...
.desktop-menu{display:none;align-items:center;gap:1.25rem}
@media (min-width:1024px){.desktop-menu{display:flex}}
.hamburger-btn{position:absolute;left:1rem;background:transparent;border:none;color:#111;padding:.5rem;cursor:pointer;display:flex;align-items:center;justify-content:center;border-radius:.5rem;transition:background .2s}
.hamburger-btn:hover{background:rgba(0,0,0,.05)}
@media (min-width:1024px){.hamburger-btn{display:none}}
.sidebar-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.5);opacity:0;visibility:hidden;transition:opacity .3s,visibility .3s;z-index:998}
.sidebar-overlay.active{opacity:1;visibility:visible}
.mobile-sidebar{position:fixed;top:0;left:0;bottom:0;width:280px;max-width:85vw;background:#fff;box-shadow:2px 0 20px rgba(0,0,0,.15);transform:translateX(-100%);transition:transform .3s;z-index:999;display:flex;flex-direction:column}
.mobile-sidebar.active{transform:translateX(0)}
@media (min-width:1024px){.mobile-sidebar,.sidebar-overlay{display:none!important}}
...
.close-btn{background:transparent;border:none;color:#111;padding:.5rem;cursor:pointer;display:flex;align-items:center;justify-content:center;border-radius:.5rem;transition:background .2s}
...
<main style="padding-top:<?= $navHeight ?>px">
  ...
  <section style="background:#fff;padding:3rem 0 3rem">
    ...
    <div class="hero-text-section" style="text-align:center;padding:2.5rem 1.5rem 3rem;max-width:900px;margin:0 auto">
        ...
        <h1 class="hero-main-heading" style="font-size:clamp(32px,5vw,52px);line-height:1.25;color:#111;margin-bottom:.75rem;font-weight:700;font-family:'DM Sans',sans-serif"><?= htmlspecialchars($heroHeadline) ?></h1>
        <?php endif; ?>
        ...
        <?php if (!empty($heroTagline)): ?>
            ...
            <?php else: ?>
                ...
                <p class="hero-tagline" style="color:#9ca3af;font-size:.95rem;letter-spacing:.08em;text-transform:uppercase;font-weight:500;line-height:1.6"><?= htmlspecialchars($heroTagline) ?></p>
            <?php endif; ?>
        <?php endif; ?>
    </div>
    ...
    @media(max-width:768px){
      ...
      .hero-tagline{font-size:.82rem !important;letter-spacing:.06em !important}
      /* Show mobile tagline, hide desktop */
    ...
    @media(max-width:480px){
      ...
      .hero-tagline{font-size:.75rem !important;letter-spacing:.05em !important;line-height:1.8 !important}
    }
...
<section id="about" style="background:#000;padding:4rem 2rem;text-align:center;margin:0;width:100vw;margin-left:calc(50% - 50vw);margin-right:calc(50% - 50vw)">
  <div style="max-width:1400px;margin:0 auto">
    ...
    <!-- Stats Grid -->
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:3rem;margin-bottom:6.5rem">
      ...
      <div>
        ...
        <div style="color:#9ca3af;font-size:0.85rem;text-transform:uppercase;letter-spacing:0.1em;font-weight:900">
    ...
    <div style="font-family:'Bebas Neue',sans-serif;font-size:clamp(2.5rem,6vw,4.5rem);color:#fff;font-weight:900;letter-spacing:0.08em;text-transform:uppercase">
