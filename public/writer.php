...
<div style="max-width:1280px;margin:0 auto;padding:0 1.5rem 5rem">
  <div class="submit-card" x-data="writerSubmit()">
    <p style="font-family:'Bebas Neue',sans-serif;font-size:clamp(22px,3.5vw,32px);letter-spacing:.04em;color:#111;margin-bottom:.3rem">Ready to Write? Submit Your Continuation</p>
    <p style="font-size:.85rem;color:#6b7280;margin-bottom:1.5rem;line-height:1.55">Read the given script, write what happens next, then record yourself narrating it on camera.</p>
