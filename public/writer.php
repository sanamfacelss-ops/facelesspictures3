...
$writerBrief   = $settingsModel->get('writer_brief',
    'Scene 1 ends with the line: "I never thought you\'d come back." Write Scene 2 — 1 to 3 pages. Proper screenplay format. Submit as PDF or perform a reading on video.');
...
.badge-script{background:linear-gradient(135deg,#7C5CBF,#5B3FA6)}
.badge-reading{background:linear-gradient(135deg,#E6A817,#C8870A)}
.badge-original{background:linear-gradient(135deg,#059669,#047857)}
...
<nav class="fp-nav fixed top-0 left-0 right-0 z-50 h-14">
  <div class="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="/writer"   class="text-amber text-xs font-semibold tracking-widest uppercase">Writer</a>
    </div>
  </div>
</nav>
...
<section class="pt-24 pb-12 px-4">
  <div class="max-w-4xl mx-auto text-center fade-up">
    ...
    <h1 class="font-display text-[52px] sm:text-[72px] md:text-[88px] leading-none text-warm mb-4">WRITER<br>SUBMISSIONS</h1>
    <p class="text-muted text-base sm:text-lg max-w-lg mx-auto leading-relaxed">
      We give you Scene 1. You write what happens next. Great scripts become great films — no name, no face, just words.
    </p>
  </div>
</section>
  ...
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="audition-card p-6 md:p-8" x-data="submissionForm('writer','Script Submission','Script Submission',<?= json_encode($writerBrief) ?>)">
      <div class="flex items-start gap-4 mb-6">
        ...
        <div>
          <h2 class="font-display text-[28px] sm:text-[36px] leading-none text-warm">SCRIPT SUBMISSION</h2>
          <p class="text-muted text-sm mt-1">Write Scene 2. Submit as a video reading.</p>
        </div>
      </div>
      <div class="mb-6">
    ...
    <div class="audition-card p-6 md:p-8" x-data="submissionForm('writer','Script Reading','Script Reading','Record yourself reading a scene or monologue you\'ve written. Let your voice carry the story — no acting required, just conviction. 60–90 seconds. Any phone camera. Your words, your read.')">
      <div class="flex items-start gap-4 mb-6">
        ...
        <div>
          <h2 class="font-display text-[28px] sm:text-[36px] leading-none text-warm">SCRIPT READING</h2>
          <p class="text-muted text-sm mt-1">Perform a reading of your original work on camera.</p>
        </div>
      </div>
      <div class="mb-6">
        <div class="flex items-center justify-between mb-2">
