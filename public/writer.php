  ...
  <div class="submit-card" style="margin:0" x-data="writerSubmit()">
    ...
    <div style="margin-top:1.25rem">
      <label style="display:flex;align-items:center;gap:.85rem;cursor:pointer;user-select:none">
        ...
        <span style="color:#111;font-size:1rem;font-weight:600;line-height:1.5"><?= htmlspecialchars($settingsModel->get('writer_terms_text', 'I agree to the terms and conditions and confirm all information provided is accurate')) ?></span>
      </label>
    </div>
