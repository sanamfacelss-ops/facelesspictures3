...
<nav class="fp-nav">
  <div style="max-width:1280px;margin:0 auto;padding:0 1.5rem;height:100%;display:flex;align-items:center;justify-content:space-between">
    ...
    <div style="display:flex;gap:1.5rem;align-items:center">
      ...
      <a href="/writer"   style="font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#111;text-decoration:none;border-bottom:2px solid #111;padding-bottom:1px">Writer</a>
    </div>
  </div>
</nav>
...
<section style="padding:4.5rem 1.5rem 1.75rem;text-align:center" class="fade-up">
  ...
  <p style="color:#6b7280;font-size:.85rem;max-width:480px;margin:0 auto;line-height:1.55"><?= htmlspecialchars($writerBrief) ?></p>
</section>
...
?>
  ...
  <div class="brief-card">
    ...
    <div class="card-sec" style="background:#111;border-bottom:none;padding:1rem 1.125rem .875rem">
      <p style="font-family:'Bebas Neue',sans-serif;font-size:1.5rem;letter-spacing:.06em;color:#fff;line-height:1;margin-bottom:.3rem">WRITER SUBMISSION</p>
      <p style="font-size:.72rem;color:rgba(255,255,255,.55);line-height:1.5">Read the script, write what happens next, then record yourself narrating it on camera.</p>
    </div>
  ...
  <div class="submit-card" style="margin:0" x-data="writerSubmit()">
    <p style="font-family:'Bebas Neue',sans-serif;font-size:clamp(20px,2.5vw,28px);letter-spacing:.04em;color:#111;margin-bottom:.3rem">Ready to Write? Submit Your Continuation</p>
    <p style="font-size:.82rem;color:#6b7280;margin-bottom:1.25rem;line-height:1.55">Read the given script, write what happens next, then record yourself narrating it on camera.</p>
