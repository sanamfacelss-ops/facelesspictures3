...
.badge-script{background:#111;color:#fff}
.badge-reading{background:#374151;color:#fff}
.badge-original{background:#4b5563;color:#fff}
...
<nav class="fp-nav fixed top-0 left-0 right-0 z-50 h-14">
  <div class="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="/writer"   style="font-size:11px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:#111;text-decoration:none">Writer</a>
    </div>
  </div>
</nav>
