-- Migration 009: Add image_url, audition_type, rules columns to scripts table
-- Run with: php database/run-migrations.php
-- Compatible with MySQL 5.7+

ALTER TABLE scripts ADD COLUMN image_url VARCHAR(500) NULL AFTER duration_hint;
ALTER TABLE scripts ADD COLUMN audition_type VARCHAR(100) NULL AFTER image_url;
ALTER TABLE scripts ADD COLUMN rules TEXT NULL AFTER audition_type;
